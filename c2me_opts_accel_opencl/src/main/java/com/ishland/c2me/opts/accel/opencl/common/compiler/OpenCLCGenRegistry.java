...
public class OpenCLCGenRegistry {
   ...
   static {
      ...
      OpenCLCGenData.REGISTRY.registerExactMatch(DelegateNode.class, (OpenCLCEmitter)(node, context, storeTo) -> {
         throw new UnsupportedOperationException(String.format("Unsupported density function type: %s", ((com.ishland.c2me.opts.dfc.common.ast.misc.DelegateNode) node).getDelegate().getClass()));
      });
   }
}
